    ...
    <Container>
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-lg text-zinc-600">
          Investor:{" "}
          <span className="font-semibold text-zinc-900">{investorId}</span>
        </p>
        <PortalNav />
      </div>
      ...
      <Section
        ...
        description="Add active deals here as you review them."
      >
        <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-6 text-sm text-zinc-700">
          ...
          <ul className="mt-3 space-y-2">
            <li>• Deal — address / all-in / rent / timeline</li>
            <li>• Notes — decisions, next steps</li>
          </ul>
        </div>
      </Section>

      <Section
        title="Investor-only docs"
        description="Gated PDFs served through the portal API."
      >
        <div className="grid gap-3 md:grid-cols-2">
          ...
          >
            ...
            <div className="mt-2 text-sm text-zinc-600">
              Execution principles and guardrails.
            </div>
          </a>
